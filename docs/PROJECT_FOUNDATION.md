...
| 5. Pose Features로 이어가기 | 관절 좌표를 손 모양 판정 재료로 변환 | 특징 계산 입력 구조 설명 | 합성 입력 테스트와 실기기 비교 |
...
| 2026-08-18 | 튜토리얼 본문 작성은 장별 오너와 교차 리뷰 방식으로 진행한다. @im-siu는 1~3장, @sueheo는 4~5장을 맡고, 각 장은 원칙적으로 한 Issue와 한 PR로 관리한다. | #11 | #12 예정 |
