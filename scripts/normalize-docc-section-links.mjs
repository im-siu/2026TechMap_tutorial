...
const highlightLinesByFile = {
  ...
  "05-01-PoseFeatureModels.swift": range(1, 91),
  "05-02-BilateralPinchPose.swift": range(1, 18),
  "05-03-BilateralPinchPose-Feature.swift": range(1, 78),
  "05-04-BilateralPinchPose-Evaluation.swift": range(1, 38),
